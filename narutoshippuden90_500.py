...
def get_content(html):
    ...
    for item in items:
        naruto = item.get('data-player-1080')
    return naruto


def download():
    for i in range(89, 501):
        URL = f'https://jut.su/narutoo/season-2/episode-{i}.html'
        html = get_html(URL)
        time.sleep(5)
        ...
        if down.status_code == 200:
            with open(f'C:\\Users\\Ivan-\\PycharmProjects\\jutsuparse\\series2\\{i}.mp4', 'wb') as f:
